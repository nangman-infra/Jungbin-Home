...
def REPO_SLUG = 'nangman-infra/Jungbin-Home'
def MAIN_BRANCH_REF = 'refs/heads/main'
def DEFAULT_REPO_HTTP_URL = 'https://github.com/nangman-infra/Jungbin-Home.git'
...
pipeline {
    ...
    triggers {
        GenericTrigger(
            ...
            causeString: 'Jungbin-Home main push detected',
                        ...
                        script {
                            ...
                            writeFile(
                                ...
                                text: """
                                    ...
                                    sonar.coverage.exclusions=src/app/**/*.tsx,src/components/ui/**/*.tsx,src/components/ui/**/*.ts,src/lib/utils.ts
