                ...
                <div className="flex flex-col gap-12">
                    ...
                    <div className="md:w-2/3 flex flex-col gap-4">
                        <div className="p-5 bg-white border border-zinc-100 rounded-xl shadow-sm hover:border-zinc-200 transition-colors">
                            <span className="inline-block px-2.5 py-1 bg-blue-50 text-blue-700 border border-blue-100 text-[11px] font-black rounded-md mb-3 tracking-wider">N-Tier Architecture</span>
                        ...
                        <div className="p-5 bg-white border border-zinc-100 rounded-xl shadow-sm hover:border-zinc-200 transition-colors">
                            <span className="inline-block px-2.5 py-1 bg-blue-50 text-blue-700 border border-blue-100 text-[11px] font-black rounded-md mb-3 tracking-wider">Container Orchestration</span>
                            <div className="flex flex-wrap gap-1.5 mb-3">
                        ...
                        <div className="p-5 bg-white border border-zinc-100 rounded-xl shadow-sm hover:border-zinc-200 transition-colors">
                            <span className="inline-block px-2.5 py-1 bg-blue-50 text-blue-700 border border-blue-100 text-[11px] font-black rounded-md mb-3 tracking-wider">CDN & Global Routing</span>
                            <div className="flex flex-wrap gap-1.5 mb-3">
                    ...
                    <div className="md:w-2/3 flex flex-col gap-4">
                        <div className="p-5 bg-white border border-zinc-100 rounded-xl shadow-sm hover:border-zinc-200 transition-colors">
                            <span className="inline-block px-2.5 py-1 bg-emerald-50 text-emerald-700 border border-emerald-100 text-[11px] font-black rounded-md mb-3 tracking-wider">IaC Automation</span>
                            <div className="flex flex-wrap gap-1.5 mb-3">
                        ...
                        <div className="p-5 bg-white border border-zinc-100 rounded-xl shadow-sm hover:border-zinc-200 transition-colors">
                            <span className="inline-block px-2.5 py-1 bg-emerald-50 text-emerald-700 border border-emerald-100 text-[11px] font-black rounded-md mb-3 tracking-wider">GitOps & CI/CD</span>
                            <div className="flex flex-wrap gap-1.5 mb-3">
                    ...
                    <div className="md:w-2/3 flex flex-col gap-4">
                        <div className="p-5 bg-white border border-zinc-100 rounded-xl shadow-sm hover:border-zinc-200 transition-colors">
                            <span className="inline-block px-2.5 py-1 bg-orange-50 text-orange-700 border border-orange-100 text-[11px] font-black rounded-md mb-3 tracking-wider">Metrics & Dashboards</span>
                            <div className="flex flex-wrap gap-1.5 mb-3">
                        ...
                        <div className="p-5 bg-white border border-zinc-100 rounded-xl shadow-sm hover:border-zinc-200 transition-colors">
                            <span className="inline-block px-2.5 py-1 bg-orange-50 text-orange-700 border border-orange-100 text-[11px] font-black rounded-md mb-3 tracking-wider">Log Analytics</span>
                            <div className="flex flex-wrap gap-1.5 mb-3">
                    ...
                    <div className="md:w-2/3 flex flex-col gap-4">
                        <div className="p-5 bg-white border border-zinc-100 rounded-xl shadow-sm hover:border-zinc-200 transition-colors">
                            <span className="inline-block px-2.5 py-1 bg-sky-50 text-sky-700 border border-sky-100 text-[11px] font-black rounded-md mb-3 tracking-wider">RDBMS & NoSQL</span>
                            <div className="flex flex-wrap gap-1.5 mb-3">
                        ...
                        <div className="p-5 bg-white border border-zinc-100 rounded-xl shadow-sm hover:border-zinc-200 transition-colors">
                            <span className="inline-block px-2.5 py-1 bg-sky-50 text-sky-700 border border-sky-100 text-[11px] font-black rounded-md mb-3 tracking-wider">In-Memory Cache</span>
                            <div className="flex flex-wrap gap-1.5 mb-3">
                    ...
                    <div className="md:w-2/3 flex flex-col gap-4">
                        <div className="p-5 bg-white border border-zinc-100 rounded-xl shadow-sm hover:border-zinc-200 transition-colors">
                            <span className="inline-block px-2.5 py-1 bg-purple-50 text-purple-700 border border-purple-100 text-[11px] font-black rounded-md mb-3 tracking-wider">Network & IAM Security</span>
                            <div className="flex flex-wrap gap-1.5 mb-3">
                        ...
                        <div className="p-5 bg-white border border-zinc-100 rounded-xl shadow-sm hover:border-zinc-200 transition-colors">
                            <span className="inline-block px-2.5 py-1 bg-purple-50 text-purple-700 border border-purple-100 text-[11px] font-black rounded-md mb-3 tracking-wider">Data Protection</span>
                            <div className="flex flex-wrap gap-1.5 mb-3">
                    ...
                    <div className="md:w-2/3 flex flex-col gap-4">
                        <div className="p-5 bg-white border border-zinc-100 rounded-xl shadow-sm hover:border-zinc-200 transition-colors">
                            <span className="inline-block px-2.5 py-1 bg-pink-50 text-pink-700 border border-pink-100 text-[11px] font-black rounded-md mb-3 tracking-wider">AIOps Pipeline</span>
                            <div className="flex flex-wrap gap-1.5 mb-3">
                        ...
                        <div className="p-5 bg-white border border-zinc-100 rounded-xl shadow-sm hover:border-zinc-200 transition-colors">
                            <span className="inline-block px-2.5 py-1 bg-pink-50 text-pink-700 border border-pink-100 text-[11px] font-black rounded-md mb-3 tracking-wider">Anomaly Detection</span>
                            <div className="flex flex-wrap gap-1.5 mb-3">
                    ...
                    <div className="md:w-1/3 shrink-0">
                        ...
                        <h4 className="font-black text-zinc-950 text-[18px]">App Architecture</h4>
                        </div>
                        <p className="text-[13px] text-zinc-500 font-bold ml-[52px]">MSA 구조 및 컨테이너 배포</p>
                    </div>
                    <div className="md:w-2/3 flex flex-col gap-4">
                        <div className="p-5 bg-white border border-zinc-100 rounded-xl shadow-sm hover:border-zinc-200 transition-colors">
                            <span className="inline-block px-2.5 py-1 bg-indigo-50 text-indigo-700 border border-indigo-100 text-[11px] font-black rounded-md mb-3 tracking-wider">Microservices & Backend</span>
                            <div className="flex flex-wrap gap-1.5 mb-3">
                                <span className="px-2 py-1 bg-white text-zinc-700 rounded text-[11px] font-black tracking-wide border border-zinc-200 shadow-sm">Node.js</span>
                                <span className="px-2 py-1 bg-white text-zinc-700 rounded text-[11px] font-black tracking-wide border border-zinc-200 shadow-sm">TypeScript</span>
                                <span className="px-2 py-1 bg-white text-zinc-700 rounded text-[11px] font-black tracking-wide border border-zinc-200 shadow-sm">NestJS</span>
                            </div>
                            <p className="text-[14px] text-zinc-600 leading-relaxed font-medium break-keep">기존 단일(Monolithic) 백엔드를 여러 목적(API Gateway, Note Service, Meeting Service 등)에 맞는 MSA 구조로 분리 설계 및 컨테이너화. 서비스 간 효율적인 라우팅 및 통신 환경 구축</p>
                        </div>
                        <div className="p-5 bg-white border border-zinc-100 rounded-xl shadow-sm hover:border-zinc-200 transition-colors">
                            <span className="inline-block px-2.5 py-1 bg-indigo-50 text-indigo-700 border border-indigo-100 text-[11px] font-black rounded-md mb-3 tracking-wider">Frontend & Monorepo</span>
                            <div className="flex flex-wrap gap-1.5 mb-3">
                                <span className="px-2 py-1 bg-white text-zinc-700 rounded text-[11px] font-black tracking-wide border border-zinc-200 shadow-sm">Next.js</span>
                                <span className="px-2 py-1 bg-white text-zinc-700 rounded text-[11px] font-black tracking-wide border border-zinc-200 shadow-sm">React</span>
                                <span className="px-2 py-1 bg-white text-zinc-700 rounded text-[11px] font-black tracking-wide border border-zinc-200 shadow-sm">Turborepo</span>
                            </div>
                            <p className="text-[14px] text-zinc-600 leading-relaxed font-medium break-keep">Turborepo를 활용한 모노레포 구조 이해 및 Next.js 애플리케이션의 최적화된 빌드/배포(Dockerize) 파이프라인 구성. 인프라 관점에서의 정적 자산 서빙 최적화</p>
                        </div>
                    </div>
                    </div>
